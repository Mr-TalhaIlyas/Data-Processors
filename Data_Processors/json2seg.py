...
output_dir = 'C:/Users/talha/Desktop/Synthetic Data/New folder/'

# path to json files
file_paths = glob.glob(os.path.join('C:/Users/talha/Desktop/Synthetic Data/New folder/', '*.json')) 
...
for i in trange(len(file_paths)):
    ...
    for j in range(len(shapes)):
        ...
        # if only 1 class can save with visible values
...
#%%
img = cv2.imread('C:/Users/talha/Desktop/Synthetic Data/New folder/2021-05-31_talha_bean_45_1623226145749.png',-1)
plt.imshow(img)