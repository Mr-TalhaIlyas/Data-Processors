...
def extract_patches(img, patchsize, overlap):
    '''
    Parameters
    ----------
...
def merge_patches(img_patches, indices):
    '''
    Parameters
    ----------
...
x, y = extract_patches(img, patchsize=32, overlap=0.2)
plt.figure()
plt.imshow(x[15])
z = merge_patches(x, y)
plt.figure()
